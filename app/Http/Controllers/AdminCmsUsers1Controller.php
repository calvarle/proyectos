<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Perfil","name"=>"id_cms_privileges","join"=>"cms_privileges,name"];
			$this->col[] = ["label"=>"Empresa","name"=>"emp_id","join"=>"empresa,nombre"];
			...
			$this->form[] = ['label'=>'Emp Id','name'=>'emp_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'empresa,nombre'];
